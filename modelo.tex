...
Baseando-se na estrutura básica presente nos arquivos de visualização do \textit{VTK}(\textit{Visu\\-alization ToolKit}) a estrutura presente na Figura~\ref{fig2:wiselement} foi criada.
