...
\item [\item $p_{term}$] Pressão terminal na posição distal \\
...
\item [\item $ktot$] Número de segmentos existentes na árvore \\
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[scale=0.25]{Figures/IGU_SCREENSHOT__00019.png}
