...
Os projetos inteligentes \textit{WiseProject} são os escopos de trabalho da ferramenta computacional, o primeiro passo para se utilizar a ferramenta é criar um projeto inteligente.
...
É possivel verificar todos os projetos do ambiente utilizando o comando de listar projetos. Todos os projetos carregados no momento da execução serão exibidos na listagem.

\begin{center}
	\begin{table}[!htbp]
		\begin{tabular}{|c|c|}
			\hline
			\textbf{Linha de Comando} & project list \\
			\hline
			\textbf{Entrada} & Nenhuma \\
			\hline
		\end{tabular}
...
\begin{table}[!htbp]
	\begin{tabular}{|c|c|}
		\hline
		\textbf{Linha de Comando} & project print \\
		\hline
		\textbf{Entrada} & Nenhuma \\
		\hline
	\end{tabular}
...
O comando de excluir projetos irá remover todas as informações do projeto selecionado , incluindo todos os seus componentes serão excluídos.
...
%--------------------------------------------------------------------------------%
\subsubsection{CRIAR ELEMENTOS}\label{sec:create_elements}
...
\begin{table}[!htbp]
	\begin{tabular}{|c|c|}
		\hline
		\textbf{Linha de Comando} & element list \\
		\hline
		\textbf{Entrada} & Nenhuma \\
		\hline
	\end{tabular}
...
O comando de excluir elementos irá excluir o elemento inteligente.
